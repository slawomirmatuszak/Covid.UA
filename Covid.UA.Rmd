...
Ukraina zajmuje **`r paste(which(grepl("Ukraina", c$Państwo)), "miejsce")`**  pod względem przyrostu nowych zakażeń w stosunku do liczby ludności. **`r nazwy.panstwa `** mają proporcjonalnie więcej nowych zakażonych w porównaniu do Ukrainy. 
